...
export const addPost = () => {
    ...
    if (text.trim().length > 0) {
        let newPost = {
            ...
            nickname: 'Re Senpai',
            text: text,
            avatar: 'https://lh3.googleusercontent.com/proxy/X2VAKVJSBZG8loapAi2e2-BI2nZuBn-Id3lIOQcCJsdmOJvVAqt4fGkIkZ38BrcS74VpQPWF8__sIcZ-J4N2LdzJr0kKBL6H8Yda7DNZpx61bhQSB2cKqg9axs3SmjTZc75rK1DsgQ',
            like: 0 
        }
